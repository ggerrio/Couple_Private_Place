            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-[var(--text-muted)]">
                  A cozy space where Gerrio and Nicole share their feelings, stay in sync with each other's moods, and experience every day together through their local weather.
                </p>
              </div>
            </div>
